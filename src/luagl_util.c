...
void luagl_register_lib(lua_State *L, const char* name, const luaL_Reg* funcs)
{
...
void luagl_register_funcs(lua_State *L, const luaL_Reg* funcs)
{
#if LUA_VERSION_NUM < 502
